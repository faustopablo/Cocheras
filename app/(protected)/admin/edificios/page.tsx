...
export default async function AdminEdificiosPage() {
  ...
  return (
    <div className="flex flex-col gap-6">
      <div>
        <h1 className="text-2xl font-bold text-foreground">Edificios y cocheras</h1>
        <p className="text-sm text-muted-foreground">
          ABM de edificios, subsuelos y cocheras. Asigná cocheras fijas a un colaborador y marcá
          cuáles son prereservadas.
        </p>
      </div>
      <BuildingsManager
