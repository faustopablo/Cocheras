...
-- Reglas globales
-- ---------------------------------------------------------------------
insert into public.parking_rules (building_id, dias_max_reserva_futura, horas_max_por_reserva, max_reservas_simultaneas_por_usuario, minutos_tolerancia_no_show)
values (null, 14, 12, 1, 30)
